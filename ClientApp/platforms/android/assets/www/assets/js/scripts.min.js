...
};var old=$.fn.tab;$.fn.tab=function(option){return this.each(function(){var $this=$(this),data=$this.data("bs.tab");data||$this.data("bs.tab",data=new Tab(this)),"string"==typeof option&&data[option]()})},$.fn.tab.Constructor=Tab,$.fn.tab.noConflict=function(){return $.fn.tab=old,this},$(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(e){e.preventDefault(),$(this).tab("show")})}(jQuery),+function($){"use strict";var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options),this.$window=$(window).on("scroll.bs.affix.data-api",$.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",$.proxy(this.checkPositionWithEventLoop,this)),this.$element=$(element),this.affixed=this.unpin=this.pinnedOffset=null,this.checkPosition()};Affix.RESET="affix affix-top affix-bottom",Affix.DEFAULTS={offset:0},Affix.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(Affix.RESET).addClass("affix");var scrollTop=this.$window.scrollTop(),position=this.$element.offset();return this.pinnedOffset=position.top-scrollTop},Affix.prototype.checkPositionWithEventLoop=function(){setTimeout($.proxy(this.checkPosition,this),1)},Affix.prototype.checkPosition=function(){if(this.$element.is(":visible")){var scrollHeight=$(document).height(),scrollTop=this.$window.scrollTop(),position=this.$element.offset(),offset=this.options.offset,offsetTop=offset.top,offsetBottom=offset.bottom;"top"==this.affixed&&(position.top+=scrollTop),"object"!=typeof offset&&(offsetBottom=offsetTop=offset),"function"==typeof offsetTop&&(offsetTop=offset.top(this.$element)),"function"==typeof offsetBottom&&(offsetBottom=offset.bottom(this.$element));var affix=null!=this.unpin&&scrollTop+this.unpin<=position.top?!1:null!=offsetBottom&&position.top+this.$element.height()>=scrollHeight-offsetBottom?"bottom":null!=offsetTop&&offsetTop>=scrollTop?"top":!1;if(this.affixed!==affix){this.unpin&&this.$element.css("top","");var affixType="affix"+(affix?"-"+affix:""),e=$.Event(affixType+".bs.affix");this.$element.trigger(e),e.isDefaultPrevented()||(this.affixed=affix,this.unpin="bottom"==affix?this.getPinnedOffset():null,this.$element.removeClass(Affix.RESET).addClass(affixType).trigger($.Event(affixType.replace("affix","affixed"))),"bottom"==affix&&this.$element.offset({top:scrollHeight-offsetBottom-this.$element.height()}))}}};var old=$.fn.affix;$.fn.affix=function(option){return this.each(function(){var $this=$(this),data=$this.data("bs.affix"),options="object"==typeof option&&option;data||$this.data("bs.affix",data=new Affix(this,options)),"string"==typeof option&&data[option]()})},$.fn.affix.Constructor=Affix,$.fn.affix.noConflict=function(){return $.fn.affix=old,this},$(window).on("load",function(){$('[data-spy="affix"]').each(function(){var $spy=$(this),data=$spy.data();data.offset=data.offset||{},data.offsetBottom&&(data.offset.bottom=data.offsetBottom),data.offsetTop&&(data.offset.top=data.offsetTop),$spy.affix(data)})})}(jQuery);var myApp=angular.module("myApp",["ngRoute","ngResource","LocalStorageModule","ngSanitize","google-maps","angular-websql","ngTouch","angular-carousel"]);angular.module("MyApp",["angular-carousel"]),myApp.config(["localStorageServiceProvider",function(localStorageServiceProvider){localStorageServiceProvider.setPrefix("bonoway")}]);var db;myApp.filter("makeRate",function(){return function(input){return null===input?"":0===input?'<span class="glyphicon glyphicon-thumbs-down"></span>':1===input?'<span class="glyphicon glyphicon-star"></span>':2===input?'<span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span>':3===input?'<span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span>':"-"}}),myApp.controller("mainController",function($scope,$location,$webSql){$scope.isActive=function(viewLocation){return viewLocation===$location.path()},$scope.notActive=function(viewLocation){return viewLocation===$location.path()};var dataSites,dataSectors,dataLines,dataParkings=[];$.ajax({url:"datas/html/sites.html",type:"get",async:!1,success:function(html){dataSites=angular.fromJson(String(html))}}),$.ajax({url:"datas/html/sectors.html",type:"get",async:!1,success:function(html){dataSectors=angular.fromJson(String(html))}}),$.ajax({url:"datas/html/lines.html",type:"get",async:!1,success:function(html){dataLines=angular.fromJson(String(html))}}),$.ajax({url:"datas/html/parkings.html",type:"get",async:!1,success:function(html){dataParkings=angular.fromJson(String(html))}}),db=$webSql.openDatabase("mydb","1.0","Test DB",2097152),db.dropTable("sites"),db.dropTable("sectors"),db.dropTable("lines"),db.dropTable("parkings"),db.createTable("sites",{id:{type:"INTEGER"},name:{type:"TEXT"},description:{type:"TEXT"},tags:{type:"TEXT"},couverture:{type:"TEXT"},latitude:{type:"TEXT"},longitude:{type:"TEXT"},volume:{type:"INTEGER"}}),db.createTable("sectors",{id:{type:"INTEGER"},name:{type:"TEXT"},latitude:{type:"TEXT"},longitude:{type:"TEXT"},approach:{type:"TEXT"},volume:{type:"INTEGER"},site:{type:"INTEGER"}}),db.createTable("lines",{id:{type:"INTEGER"},name:{type:"TEXT"},grade:{type:"TEXT"},rate:{type:"INTEGER"},latitude:{type:"TEXT"},longitude:{type:"TEXT"},description:{type:"TEXT"},image:{type:"TEXT"},site:{type:"INTEGER"},sector:{type:"INTEGER"}}),db.createTable("parkings",{id:{type:"INTEGER"},latitude:{type:"TEXT"},longitude:{type:"TEXT"},site:{type:"INTEGER"}});for(var i=0;i<dataSites.length;i++)db.insert("sites",{id:dataSites[i].id,name:dataSites[i].name,description:dataSites[i].description,tags:dataSites[i].tags,couverture:dataSites[i].couverture,latitude:dataSites[i].latitude,longitude:dataSites[i].longitude,volume:dataSites[i].volume}).then(function(results){console.log(results.insertId)});for(var i=0;i<dataSectors.length;i++)db.insert("sectors",{id:dataSectors[i].id,name:dataSectors[i].name,latitude:dataSectors[i].latitude,longitude:dataSectors[i].longitude,approach:dataSectors[i].approach,volume:dataSectors[i].volume,site:dataSectors[i].site}).then(function(results){console.log(results.insertId)});for(var draft="",i=0;i<dataLines.length;i++)draft=""===dataLines[i].description?"Pas de description.":dataLines[i].description,db.insert("lines",{id:dataLines[i].id,name:dataLines[i].name,grade:dataLines[i].grade,rate:dataLines[i].rate,latitude:dataLines[i].latitude,longitude:dataLines[i].longitude,description:draft,image:dataLines[i].image,site:dataLines[i].site,sector:dataLines[i].sector}).then(function(results){console.log(results.insertId)});for(var i=0;i<dataParkings.length;i++)db.insert("parkings",{id:dataParkings[i].id,latitude:dataParkings[i].latitude,longitude:dataParkings[i].longitude,site:dataParkings[i].site}).then(function(results){console.log(results.insertId)})}),myApp.controller("SiteListCtrl",function($scope,$location){db.selectAll("sites").then(function(results){for($scope.sites=[],i=0;i<results.rows.length;i++)$scope.sites.push(results.rows.item(i))}),$scope.detail=function(siteId){$location.path("/site/"+siteId)}}),myApp.controller("SiteDetailCtrl",function($scope,$routeParams,$location){$scope.map={center:{latitude:0,longitude:0},zoom:16},id=parseInt($routeParams.siteId);var sita;$scope.site={},db.select("sites",{id:{value:id}}).then(function(results){$scope.site=results.rows.item(0),sita=results.rows.item(0),$scope.sectors=[],db.select("sectors",{site:{value:id}}).then(function(results){for(var i=0;i<results.rows.length;i++)$scope.sectors.push(results.rows.item(i));$scope.parkings=[],$scope.map={},db.selectAll("parkings").then(function(results){for(var i=0;i<results.rows.length;i++)$scope.parkings.push(results.rows.item(i));makeMap()})})}),makeMap=function(){$scope.map={center:{latitude:sita.latitude,longitude:sita.longitude},zoom:16},$scope.mapState=!0},$scope.lineList=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)}}),myApp.controller("SectorCtrl",function($scope,$routeParams,$location){$scope.map={center:{latitude:0,longitude:0},zoom:16},id=parseInt($routeParams.siteId),idd=parseInt($routeParams.sectorId);var sita;$scope.currency=idd,$filtering=function(items,x){$result=[];for(var i=0;i<items.length;i++){var item=items[i];item.sector===x&&$result.push(item)}return $result},$scope.site={},$scope.list=[],$scope.lines=[],$scope.sectors=[],db.select("sites",{id:{value:id}}).then(function(results){$scope.site=results.rows.item(0),sita=results.rows.item(0),db.select("sectors",{site:{value:id}}).then(function(results){for(var i=0;i<results.rows.length;i++)$scope.sectors.push(results.rows.item(i));db.select("lines",{site:{value:id}}).then(function(results){for(var i=0;i<results.rows.length;i++)$scope.list.push(results.rows.item(i)),results.rows.item(i).sector==idd&&$scope.lines.push(results.rows.item(i));makeMap()})})}),$scope.select=function(xid){0===xid?($scope.current={id:0,name:"Toutes les voies"},$scope.lines=$scope.list):($scope.current={},db.select("sectors",{id:{value:xid}}).then(function(results){$scope.current=results.rows.item(0)}),$scope.lines=$filtering($scope.list,xid))},makeMap=function(){$scope.map={center:{latitude:sita.latitude,longitude:sita.longitude},zoom:16},$scope.mapState=!0},$scope.maping=function(siteId,sectorId){$location.path("/site/"+siteId+"/map/"+sectorId)},$scope.listing=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)},$scope.detail=function(lineId){$location.path("/line/"+lineId)},$scope.back=function(siteId){$location.path("/site/"+siteId)}}),myApp.controller("LineDetailCtrl-carousel",function($scope,$routeParams,$location){id=parseInt($routeParams.sectorId),alert(id),$scope.lines=[],db.select("lines",{sector:{value:id}}).then(function(results){for(var i=0;i<results.rows.length;i++)$scope.lines.push(results.rows.item(i))}),$scope.backSector=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)},$scope.previous=function(lineId){var x=lineId-1;$location.path("/line/"+x)},$scope.next=function(lineId){var x=lineId+1;$location.path("/line/"+x)}}),myApp.controller("LineDetailCtrl",function($scope,$routeParams,$location){id=parseInt($routeParams.lineId),$scope.line={},db.select("lines",{id:{value:id}}).then(function(results){$scope.line=results.rows.item(0)}),$scope.backSector=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)},$scope.previous=function(lineId){var x=lineId-1;$location.path("/line/"+x)},$scope.next=function(lineId){var x=lineId+1;$location.path("/line/"+x)}}),myApp.controller("searchCtrl",function($scope,$location){$scope.activeType="all",$scope.setSearchType=function(activeType){$scope.activeType=activeType},$scope.search=function(input){var inputLarge="%%%%%%%%%%%%%%%%%%"+input+"%%%%%%%%%%%%%%%%%%%%";if($scope.resultings=[],"sites"!==$scope.activeType){db.select("lines",{name:{operator:"LIKE",value:inputLarge}}).then(function(results){for(var i=0;i<results.rows.length;i++)$scope.resultings.push(results.rows.item(i))});for(var i=0;i<input.length;i++){var stringy="%%%%%%%%%%%%%%%%%%"+input.substr(0,i)+"_"+input.substr(i+1,input.length)+"%%%%%%%%%%%%%%%%%%%%";db.select("lines",{name:{operator:"LIKE",value:stringy}}).then(function(results){for(var i=0;i<results.rows.length;i++){for(var doublon=!1,j=0;j<$scope.resultings.length;j++)$scope.resultings[j].id===results.rows.item(i).id&&(doublon=!0);doublon===!1&&$scope.resultings.push(results.rows.item(i))}})}}if("lines"!==$scope.activeType){db.select("sites",{name:{operator:"LIKE",value:inputLarge}}).then(function(results){for(var i=0;i<results.rows.length;i++)$scope.resultings.push(results.rows.item(i))});for(var i=0;i<input.length;i++){var stringy="%%%%%%%%%%%%%%%%%%"+input.substr(0,i)+"_"+input.substr(i+1,input.length)+"%%%%%%%%%%%%%%%%%%%%";db.select("sites",{name:{operator:"LIKE",value:stringy}}).then(function(results){for(var i=0;i<results.rows.length;i++){for(var doublon=!1,j=0;j<$scope.resultings.length;j++)$scope.resultings[j].id===results.rows.item(i).id&&(doublon=!0);doublon===!1&&$scope.resultings.push(results.rows.item(i))}})}}},$scope.detailSite=function(siteId){$location.path("/site/"+siteId)},$scope.detailLine=function(lineId){$location.path("/line/"+lineId)}}),myApp.controller("aboutCtrl",function($scope){$scope.title="A propos",$scope.message="Help page"}),myApp.config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){$locationProvider.html5Mode(!1),$routeProvider.when("/",{templateUrl:"partials/default.html",controller:"mainController"}).when("/sites",{templateUrl:"partials/site/list.html",controller:"SiteListCtrl"}).when("/site/:siteId",{templateUrl:"partials/site/detail.html",controller:"SiteDetailCtrl"}).when("/site/:siteId/sector/:sectorId",{templateUrl:"partials/sector/list.html",controller:"SectorCtrl"}).when("/site/:siteId/map/:sectorId",{templateUrl:"partials/sector/map.html",controller:"SectorCtrl"}).when("/line/:lineId",{templateUrl:"partials/line/detail.html",controller:"LineDetailCtrl"}).when("/search",{templateUrl:"partials/search.html",controller:"searchCtrl"}).when("/about",{templateUrl:"partials/about.html",controller:"aboutCtrl"}).otherwise({redirectTo:"/",controller:"mainController"})}]);